    ...
    public class Marginp : Common, IMarginp
    {
        ...
        public Tuple<bool, string> CDCApproved(TreasuryDBEntities db, List<string> itemIDs, string logStr, DateTime dt)
        {
            foreach (var itemID in itemIDs)
            {
                ...
                {
                    _Marginp.INVENTORY_STATUS = "1"; //在庫
                    _Marginp.MARGIN_TAKE_OF_TYPE = string.IsNullOrEmpty(_Marginp.MARGIN_TAKE_OF_TYPE_AFT) ? _Marginp.MARGIN_TAKE_OF_TYPE : _Marginp.MARGIN_TAKE_OF_TYPE_AFT;
                    _Marginp.MARGIN_TAKE_OF_TYPE_AFT = null;
                    _Marginp.TRAD_PARTNERS = string.IsNullOrEmpty(_Marginp.TRAD_PARTNERS_AFT) ? _Marginp.TRAD_PARTNERS : _Marginp.TRAD_PARTNERS_AFT;
                    _Marginp.TRAD_PARTNERS_AFT = null;
                    ...
                    _Marginp.AMOUNT_AFT = null;
                    _Marginp.MARGIN_ITEM = string.IsNullOrEmpty(_Marginp.MARGIN_ITEM_AFT) ? _Marginp.MARGIN_ITEM : _Marginp.MARGIN_ITEM_AFT;
                    _Marginp.MARGIN_ITEM_AFT = null;
                    _Marginp.MARGIN_ITEM_ISSUER = string.IsNullOrEmpty(_Marginp.MARGIN_ITEM_ISSUER_AFT) ? _Marginp.MARGIN_ITEM_ISSUER : _Marginp.MARGIN_ITEM_ISSUER_AFT;
                    _Marginp.MARGIN_ITEM_ISSUER_AFT = null;
                    _Marginp.PLEDGE_ITEM_NO = string.IsNullOrEmpty(_Marginp.PLEDGE_ITEM_NO_AFT) ? _Marginp.PLEDGE_ITEM_NO : _Marginp.PLEDGE_ITEM_NO_AFT;
                    _Marginp.PLEDGE_ITEM_NO_AFT = null;
                    _Marginp.EFFECTIVE_DATE_B = string.IsNullOrEmpty(TypeTransfer.dateTimeNToString(_Marginp.EFFECTIVE_DATE_B_AFT)) ? _Marginp.EFFECTIVE_DATE_B : _Marginp.EFFECTIVE_DATE_B_AFT;
                    _Marginp.EFFECTIVE_DATE_B_AFT = null;
                    _Marginp.EFFECTIVE_DATE_E = string.IsNullOrEmpty(TypeTransfer.dateTimeNToString(_Marginp.EFFECTIVE_DATE_E_AFT)) ? _Marginp.EFFECTIVE_DATE_E : _Marginp.EFFECTIVE_DATE_E_AFT;
                    _Marginp.EFFECTIVE_DATE_E_AFT = null;
                    _Marginp.DESCRIPTION = string.IsNullOrEmpty(_Marginp.DESCRIPTION_AFT) ? _Marginp.DESCRIPTION : _Marginp.DESCRIPTION_AFT;
                    _Marginp.DESCRIPTION_AFT = null;
                    _Marginp.MEMO = string.IsNullOrEmpty(_Marginp.MEMO_AFT) ? _Marginp.MEMO : _Marginp.MEMO_AFT;
                    _Marginp.MEMO_AFT = null;
                    _Marginp.LAST_UPDATE_DT = dt;
                    logStr = _Marginp.modelToString(logStr);
                }
