...
namespace Treasury.Web.Service.Interface
{
    ...
    public interface ITinAction
    {
        ...
        /// <returns></returns>
        Tuple<bool, string> TinReject(TreasuryDBEntities db, List<string> itemIDs, string logStr, DateTime dt);
        ...
        /// <param name="dt">執行時間</param>
        /// <returns></returns>
        Tuple<bool, string> TinApproved(TreasuryDBEntities db, List<string> itemIDs, string logStr, DateTime dt);
