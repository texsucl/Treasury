...
namespace Treasury.Web.Report.Data
{
    public class DEPOSIT_DEP_ORDER_M : ReportDepositData
    {
        ...
        private Tuple<List<DepositReportDEPOSIT_DEP_ORDER_M_Data>, decimal> setData(List<ITEM_DEP_ORDER_D> _ITEM_DEP_ORDER_D, DepositReportDEPOSIT_DEP_ORDER_M_Data item)
        {
            List<DepositReportDEPOSIT_DEP_ORDER_M_Data> tempData =
                            new List<DepositReportDEPOSIT_DEP_ORDER_M_Data>();
            ...
            return new Tuple<List<DepositReportDEPOSIT_DEP_ORDER_M_Data>, decimal>(tempData, total_DENOMINATION);
        }
    }
}
