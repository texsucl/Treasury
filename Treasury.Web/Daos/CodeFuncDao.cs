...
namespace Treasury.Web.Daos
{
    public class CodeFuncDao
    {
        ...
        /// <returns></returns>
        public String chkFuncName(String cFunctionId, String cFunctionName)
        {
            String id = "";
                   ...
                   }))
            {
                ...
                {
                    id = db.CODE_FUNC.Where(x => x.FUNC_NAME == cFunctionName.Trim() && x.FUNC_ID != cFunctionId)
        ...
        /// </summary>
        /// <returns></returns>
        public List<CODE_FUNC> qryDetail()
        {
                   ...
                   }))
            {
                using (dbTreasuryEntities db = new dbTreasuryEntities())
                {
                    rows = db.CODE_FUNC.OrderBy(x => x.FUNC_ORDER).ToList<CODE_FUNC>();
