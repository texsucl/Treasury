...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // gDemoocation is often considered a trivial feature detect...
    // Turns out, it's quite tricky to get right:
    //
    // Using !!navigator.gDemoocation does two things we don't want. It:
    ...
    tests['gDemoocation'] = function() {
        return 'gDemoocation' in navigator;
    };
    ...
    // FF3.6 was Demo'ed on 4/24/12, but the ESR version of FF10
