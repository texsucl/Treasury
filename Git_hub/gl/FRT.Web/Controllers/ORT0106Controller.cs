...
namespace FRT.Web.Controllers
{
    public class ORT0106Controller : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                String[] roleInfo = authUtil.chkUserFuncAuth(Session["UserID"].ToString(), "~/ORT0106/");
            ...
            ViewBag.cross_system = new SelectList(ORT0106.getCross_System("AP"), "Value", "Text");
            return View();
        }
        ...
        public JsonResult GetReport(ORT0106ViewModel model)
        {
            ...
            if (result.RETURN_FLAG)
            {
                ...
                var _report = _IORT0105Report.check(_check, _userId, ReportType.R, model.date_s, model.date_e);
