...
namespace FRT.Web.Controllers
{
    public class ORT0108Controller : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                String[] roleInfo = authUtil.chkUserFuncAuth(Session["UserID"].ToString(), "~/ORT0108/");
            ...
            ViewBag.cross_system = new SelectList(ORT0106.getCross_System("NP"), "Value", "Text");
            return View();
        }
        ...
        public JsonResult GetReport(ORT0106ViewModel model)
        {
            ...
            switch (_type)
            {
                ...
                case "NP_3":
                    result.RETURN_FLAG = true;
                    model.className = "ORT0105NP3";
                    _IORT0105Report = new ORT0105NP3();
                    break;
                case "NP_4":
            ...
            if (result.RETURN_FLAG)
            {
                ...
                var _report = _IORT0105Report.check(_check, _userId, ReportType.S, model.date_s, model.date_e);
                if (_report.RETURN_FLAG)
                {
                    ...
                    //model.title_Date = $@"{_title_date.Item3}";
