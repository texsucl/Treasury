...
namespace FRT.Web.Controllers
{
    ...
    public class ORT0101AController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                String[] roleInfo = authUtil.chkUserFuncAuth(Session["UserID"].ToString(), "~/ORT0101A/");
        ...
        public JsonResult LoadData(string groupId)
        {
            ...
            try {
                ...
                List<ORT0101Model> rows = new List<ORT0101Model>();
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult execSave(string groupId, List<ORT0101Model> recData, List<ORT0101Model> rtnData)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strConn)) { 
                ...
                if (rtnData.Count > 0)
                {
                    foreach (ORT0101Model d in rtnData)
                    {
                ...
                if (recData.Count > 0)
                {
                    ...
                    using (EacConnection conn400 = new EacConnection(CommonUtil.GetEasycomConn()))
                    {
                        ...
                        foreach (ORT0101Model d in recData)
                        {
                            SqlTransaction transaction = conn.BeginTransaction("Transaction");
                                    ...
                                    if (_his == null)
                                    {
                                        ...
                                        switch (_his.status) {
                                            ...
                                            case "A":
                                                ...
                                                break;
                                            case "U":
                                                fRTCODEDao.updateFRTCODE0(Session["UserID"].ToString(), _his, conn400, transaction400);
                                                break;
