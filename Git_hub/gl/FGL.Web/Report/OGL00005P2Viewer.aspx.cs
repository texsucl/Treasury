...
{
    public partial class OGL00005P2Viewer : System.Web.UI.Page
    {
        ...
        private void GenerateReport(string id)
        {
            ...
            if (rw != null)
            {
                ...
                try
                {
                    ...
                    RptViewer.LocalReport.SetParameters(new ReportParameter("Title", "商品資料接收報表-會科異動紀錄"));
                    ...
                    RptViewer.LocalReport.SetParameters(new ReportParameter("item", para["item"]));
                    RptViewer.LocalReport.SetParameters(new ReportParameter("execAction", para["execAction"]));
                    //// 子報表事件
