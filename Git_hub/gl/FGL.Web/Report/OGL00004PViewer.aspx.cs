...
{
    public partial class OGL00004PViewer : System.Web.UI.Page
    {
        ...
        private void GenerateReport(string id)
        {
            ...
            if (rw != null)
            {
                ...
                try
                {
                    ...
                    RptViewer.LocalReport.SetParameters(new ReportParameter("Title", "投資交易商品資料維護報表"));
                    ...
                    RptViewer.LocalReport.SetParameters(new ReportParameter("investUpDt", para["investUpDt"]));
                    RptViewer.LocalReport.SetParameters(new ReportParameter("investUpId", para["investUpId"]));
                    RptViewer.LocalReport.SetParameters(new ReportParameter("investApprId", para["investApprId"]));
