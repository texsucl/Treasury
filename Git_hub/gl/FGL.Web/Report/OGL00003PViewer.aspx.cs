...
{
    public partial class OGL00003PViewer : System.Web.UI.Page
    {
        ...
        private void GenerateReport(string id)
        {
            ...
            if (rw != null)
            {
                ...
                try
                {
                    ...
                    RptViewer.LocalReport.SetParameters(new ReportParameter("Title", "商品資料維護報表"));
                    ...
                    RptViewer.LocalReport.SetParameters(new ReportParameter("prodUpDt", para["prodUpDt"]));
                    RptViewer.LocalReport.SetParameters(new ReportParameter("prodUpId", para["prodUpId"]));
                    RptViewer.LocalReport.SetParameters(new ReportParameter("prodApprId", para["prodApprId"]));
