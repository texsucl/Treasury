(function (window, undefind) {
    ...
    customerUtility.alertAuto = function (result, style)
    {
        ...
        style = style || '';
        if (flag) {
            customerUtility.alert(msg, 's', style);
        }
        else {
            customerUtility.alert(msg, 'e', style);
        }
    }

    customerUtility.alert = function (message, type, style) {
        type = type || '';
        var flag = '';
        style = style || '';
        if (style == '')
        ...
        {
            customerUtility.reSetSummary(message);
        }
        else
            alert(message);
    }

    customerUtility.reSetSummary = function reSetSummary(message)
    {
        message = message || '';
