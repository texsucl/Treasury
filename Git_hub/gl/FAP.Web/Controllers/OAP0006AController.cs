...
namespace FRT.Web.Controllers
{
    ...
    public class OAP0006AController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                String[] roleInfo = authUtil.chkUserFuncAuth(Session["UserID"].ToString(), "~/OAP0006A/");
            ...
            ViewBag.veClrTypejqList = sysCodeDao.jqGridList("AP", "VE_CLR_TYPE", false);
        ...
        public JsonResult LoadData()
        {
            ...
            try {
                List<VeTraceModel> rows = fAPVeCodeHisDao.qryInProssByGrp(new string[] { "CLR_CERT_DOC"
                    , "CLR_LEVEL1", "CLR_LEVEL2", "CLR_PRACTICE" });
